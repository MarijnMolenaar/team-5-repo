...
exports.validateUserSignUp = [
    check('name').trim().not().isEmpty().withMessage('- Name is empty').isLength({
        min: 3,
        max: 20
    }).
    ...
    check('confirmName').trim().not().isEmpty().custom((value, {
        req
    }) => {
    ...
    check('ConfirmEmail').trim().not().isEmpty().custom((value, {
        req
    }) => {
    ...
    check('ConfirmPassword').trim().not().isEmpty().custom((value, {
        req
    }) => {
    ...
    check('name_a').trim().not().isEmpty().withMessage('- You must fill in the name of your animale').isLength({
        min: 3,
        max: 20
    }),


    check('confirmName_a').trim().not().isEmpty().custom((value, {
        req
    }) => {
        if (value !== req.body.name_a) {
